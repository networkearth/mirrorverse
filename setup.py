...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "chinook_monthly_states=mirrorverse.chinook_monthly.states:main",
            "chinook_monthly_train=mirrorverse.chinook_monthly.train:main",
            "chinook_monthly_simulate=mirrorverse.chinook_monthly.simulate:main",
