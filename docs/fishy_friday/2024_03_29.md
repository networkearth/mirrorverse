...
Something that has been bothering me has been how "squirrelly" my predictions are compared to the nice, long runs of the "actuals".  
...
What's really cool about this is that we've got two different kinds of salmon behavior showing up by (1) building a simple utility model and then (2) grouping on how well that utility model captures the individual behavior. No squinting at the data required! 

Now of course the question is - what makes these two so different and can I capture that with the data we have? 
